...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="form-group">
        <div class="col-md-4">
            <asp:DropDownList ID="DropDownListTypes" CssClass="form-control" runat="server">
                <asp:ListItem Text="Toate tipurile" Value="All" Selected="True"></asp:ListItem>
            ...
            <br />
            <asp:TextBox ID="TextBoxMake" CssClass="form-control" placeholder="Marca" runat="server"></asp:TextBox>
            <br />
            <asp:TextBox ID="TextBoxModel" CssClass="form-control" placeholder="Model" runat="server"></asp:TextBox>
            <br />
            <asp:TextBox ID="TextBoxColour" CssClass="form-control" placeholder="Telefon" runat="server"></asp:TextBox>
            <br />
            <asp:TextBox ID="TextBoxLocation" CssClass="form-control" placeholder="Locatia" runat="server"></asp:TextBox>
            <br />
        </div>
        <div class="col-md-4">
            <asp:TextBox ID="TextBoxPriceStarting" CssClass="form-control" placeholder="Pret min" runat="server"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidatorPriceStarting" runat="server" ErrorMessage="Introduceti doar numere!" ControlToValidate="TextBoxPriceStarting" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>
            <asp:TextBox ID="TextBoxPriceMaximum" CssClass="form-control" placeholder="Pret Maxim" runat="server"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidatorPriceMaximum" runat="server" ErrorMessage="Introduceti doar numere!" ControlToValidate="TextBoxPriceMaximum" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>
            <br />
            <br />
            <asp:TextBox ID="TextBoxYearStarting" CssClass="form-control" placeholder="Anul min" runat="server"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidatorYearStarting" runat="server" ErrorMessage="Introduceti doar numere!" ControlToValidate="TextBoxYearStarting" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>

            <asp:TextBox ID="TextBoxYearEnding" CssClass="form-control" placeholder="Anul max" runat="server"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidatorYearEnding" runat="server" ErrorMessage="Introduceti doar numere!" ControlToValidate="TextBoxYearEnding" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>
            <br />
            <asp:Button ID="ButtonSearch" CssClass="btn btn-lg btn-primary col-md-offset-2" runat="server" Text="Cautare" OnClick="ButtonSearch_Click" />
        </div>
    ...
    <asp:GridView ID="GridViewCars" runat="server" CssClass="table table-striped" UseAccessibleHeader="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" AllowSorting="True" AllowPaging="True" GridLines="None">
        <Columns>
            ...
            <asp:BoundField DataField="year" HeaderText="Anul" SortExpression="year" />
